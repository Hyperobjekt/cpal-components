const en_US = {
  ...
  UI_MAP_FILTER_INSTRUCTIONS: `<p>Use the dropdown menu above to select an index. You can filter which schools appear on the map by clicking the colored sections (representing quintiles) within each index. To clear filters and return to the default Community Resource Index display, press the "reset" button {icon} above.</p>`,
