const en_US = {
  ...
  TOUR_DESK_STEP_11: `The map has additional layers, like race/ethnicity by census tract, which can be activated using the layers panel.`,
  TOUR_DESK_STEP_12: `The feeder view displays all of the feeder patterns in the district. These feeders are sorted according to their average Community Resource Index (CRI), the main index in the Explorer.`,
  TOUR_DESK_STEP_13: `The feeder view also displays all of the neighborhood schools in the district, distributed according to their CRI score.`,
  TOUR_DESK_STEP_14: `Click individual feeders to see more information about them.`,
  TOUR_MOBILE_STEP_14: `Select individual feeders to see more information about them. When a feeder is selected, a modal dialog displays more information about the feeder and its schools. Select any school within the dialog to see the profile of the school community in a new tab.`,
  ...
  TOUR_DESK_STEP_17: `Search for a school community using this search bar. This will highlight the school in the distribution chart, along with its feeder pattern in the feeder chart.`,
